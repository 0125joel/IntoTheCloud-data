...
.INPUTS
.OUTPUTS
%programdata%\Microsoft\IntuneManagementExtension\Customlogs\Debloat.log
.NOTES

  Edited by:      Joël Prins
  Version:        2.991
...
#Create Folder
$DebloatFolder = "$env:programdata\Microsoft\IntuneManagementExtension\Logs\Customlogs"
